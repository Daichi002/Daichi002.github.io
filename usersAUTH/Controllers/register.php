...
$sqlQuery = mysqli_query($connection, $sql);
                    ...
                    if($sqlQuery) {
                        $msg = 'Click on the activation link to verify your email. <br><br>
                          <a href="http://localhost:8888/USERSAUTH/user_verificaiton.php?token='.$token.'"> Click here to verify email</a>
                        ';
                        // Create the Transport
                        $transport = (new Swift_SmtpTransport('smtp.gmail.com', 586, 'tls'))
                        ->setUsername('pseudo8669@gmail.com')
                        ->setPassword('ptanghacker8611');
